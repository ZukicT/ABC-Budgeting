    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showAddView) {
                AddView(loanViewModel: viewModel, budgetViewModel: budgetViewModel, transactionViewModel: transactionViewModel, budgetTransactionService: budgetTransactionService)
            }
